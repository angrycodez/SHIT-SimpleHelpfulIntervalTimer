...
class TimerStateLoaded extends TimerState {
  ...
  int get computeCurrentIntervalRemainingTimeInMillis => currentInterval.duration.inMilliseconds - (DateTime.now().millisecondsSinceEpoch - intervalStartedTimestamp!.millisecondsSinceEpoch);
